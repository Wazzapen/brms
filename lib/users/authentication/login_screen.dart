...
import 'package:bms/api/api.dart';
import 'package:bms/users/authentication/signup_screen.dart';
import 'package:bms/users/fragments/dashboard_of_fragments.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 253, 249, 9),
      body: LayoutBuilder(
                    ...
                    child: Container(
                      decoration: const BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            blurRadius: 8,
                            color: Color.fromARGB(255, 114, 233, 2),
                            offset: Offset(0, -3),
                          ),
                        ],
                      ),
